...
if ( isset( $_SESSION['email'] ) ) {
    ...
    $dept = $_POST['dept'];
        ...
        if($run){
            echo "<script>alert('Successfully Changed');window.location.href ='staff_change_other.php';</script>";
        }else{
            echo "<script>alert('Something went wrong');window.location.href ='staff_change_other.php';</script>";
        }
    }
    ?>
